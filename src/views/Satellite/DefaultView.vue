<template>
  <div id="content" class="satellite" @touchstart="touchStart" @touchend="touchEnd">
    <div :class="`sidebar ${scrollbarActiveMobile ? 'sidebar-active-mobile' : ''
      ...
      <img alt="Logo" class="logo" src="@/assets/satellite_logo.png" />
...
export default {
  ...
  methods: {
    ...
    touchEnd(e) {
      ...
      if (this.touchStartX - e.changedTouches[0].screenX > 100) {
        this.$router.push({ name: "rocket.home" });
      }
    },
    changeUnit(unit) {
